...
public class VentanaPrincipalDistrito extends JFrame implements ActionListener{
	 ...
	 */
	public VentanaPrincipalDistrito() {
		setResizable(false);
		...
		labelTitulo.setText("Menú de Administración de Distritos.");
		...
		areaIntroduccion.setText("En esta ventana podrá realizar operaciones de ABM sobre la tabla de Distrito del Sistema.");
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource()==botonRegistrar) {
			VentanaRegistroDistrito ventanaRegistro = new VentanaRegistroDistrito();
			ventanaRegistro.setVisible(true);
		}
		if (e.getSource()==botonBuscar) {
			VentanaBuscarDistrito ventanaBuscar = new VentanaBuscarDistrito();
