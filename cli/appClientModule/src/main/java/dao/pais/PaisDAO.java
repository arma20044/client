...
//	}
	...
	public JSONArray buscarPais(String codigo) throws ParseException, org.json.simple.parser.ParseException 
	{
		...
		boolean existe=false;
			...
			String res = response.getQueryGenericoResponse();
				...
				if(res.compareTo("[]")==0){
					JOptionPane.showMessageDialog(null, "El Pais no Existe","Advertencia",JOptionPane.WARNING_MESSAGE);
					return filas;
				}
