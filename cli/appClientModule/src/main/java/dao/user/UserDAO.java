	...
	public JSONArray buscarGenero(String codigo) throws ParseException, org.json.simple.parser.ParseException 
	{
		...
		boolean existe=false;
			...
			String res = response.getQueryGenericoResponse();
				...
				if(res.compareTo("[]")==0){
					JOptionPane.showMessageDialog(null, "El Genero no Existe","Advertencia",JOptionPane.WARNING_MESSAGE);
					return filas;
				}
...
//				gen.setUsuario(part3);
	...
	public Boolean eliminarUser(String codigo)
	{
		...
		try{
			...
			query.setQueryGenerico("DELETE FROM ucsaws_users WHERE"
					+ " id_user = "
					+ codigo 
					 );
