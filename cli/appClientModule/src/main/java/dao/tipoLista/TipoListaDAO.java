...
//	}
	...
	public JSONArray buscarTipoLista(String codigo) throws ParseException, org.json.simple.parser.ParseException 
	{
		...
		boolean existe=false;
			...
			String res = response.getQueryGenericoResponse();
				...
				if(res.compareTo("[]")==0){
					JOptionPane.showMessageDialog(null, "El Tipo Lista no Existe","Advertencia",JOptionPane.WARNING_MESSAGE);
					return filas;
				}
...
//				gen.setUsuario(part3);
	...
	public Boolean eliminarTipoLista(String codigo)
	{
		...
		try{
			...
			query.setQueryGenerico("DELETE FROM ucsaws_tipo_lista WHERE"
					+ " id_tipo_lista = "
					+ codigo 
					 );
