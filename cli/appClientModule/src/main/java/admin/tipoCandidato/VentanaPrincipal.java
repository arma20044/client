...
public class VentanaPrincipal extends JFrame implements ActionListener{
	...
	public VentanaPrincipal() {
		...
		labelTitulo.setText("Menú de Administración de Tipos de Candidatos.");
		labelTitulo.setBounds(60, 40, 436, 30);
		...
		areaIntroduccion.setText("En esta ventana podrá realizar operaciones de ABM sobre la tabla de Tipos de Canditatos del Sistema.");
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource()==botonRegistrar) {
			VentanaRegistro ventanaRegistro = new VentanaRegistro(miVentanaPrincipal, true);
