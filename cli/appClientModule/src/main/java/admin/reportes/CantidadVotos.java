...
public class CantidadVotos {
	
	String P_Candidato_Desc_String;
 
    private Logger logger = Logger.getLogger(CantidadVotos.class);
 
    public CantidadVotos(Integer idTipo) {
    ...
    public void start() {
        try {                                           
        	...
        	File a = new File("jasperTemplates/cantidadVotosXCandidaturaGrafico.jasper");
...
//            parameters.put("P_Candidato_Desc","Presidente de la Republica del Paraguay");
    ...
    public static void main(String[] args) {
        ...
        CantidadVotos main = new CantidadVotos(CantidadVotosElegir.tipoSelected);
