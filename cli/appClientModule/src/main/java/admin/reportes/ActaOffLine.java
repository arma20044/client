...
public class ActaOffLine {
  
  /** The Constant LOG. */
  private static final Logger LOG = Logger.getLogger(ActaOffLine.class);

  private Logger logger = Logger.getLogger(ActaOffLine.class);
  ...
  public void start() {
    ...
    try {
      ...
      //SUBREPORTES
      JasperReport sub1 = (JasperReport)JRLoader.loadObject(new File("jasperTemplates/subReport.jasper"));
      JasperReport sub2 = (JasperReport)JRLoader.loadObject(new File("jasperTemplates/subReport2.jasper"));
...
//***
      ...
      parameters.put("P_FECHA_LETRA", dia + " días del mes de " + month + " del año " + anho);
      parameters.put("P_HORA_LETRA", hour + " horas  " + minute + " minutos");
  ...
  public static void main(String[] args) {
    ...
    ActaOffLine main = new ActaOffLine();
    main.start();
  }
}
