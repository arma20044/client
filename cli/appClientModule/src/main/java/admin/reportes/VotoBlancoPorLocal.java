...
public class VotoBlancoPorLocal {
 
    private Logger logger = Logger.getLogger(VotoBlancoPorLocal.class);
 
    /**
     * @wbp.parser.entryPoint
     */
    public VotoBlancoPorLocal() {
    }
    ...
    public void start() {
        try {                                           
        	...
        	File a = new File("jasperTemplates/votosBlancosPorLocal.jasper");
...
//                map.put("address", getRandomString());
    ...
    public static void main(String[] args) {
        ...
        VotoBlancoPorLocal main = new VotoBlancoPorLocal();
        main.start();
    }
}