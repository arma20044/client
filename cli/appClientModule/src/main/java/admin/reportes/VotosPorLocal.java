...
public class VotosPorLocal {
 
    private Logger logger = Logger.getLogger(VotosPorLocal.class);
    
    private JDBCExample ds = new JDBCExample();
 
    public VotosPorLocal() {
    }
    ...
    public void start() {
        try {                                           
        	...
        	File a = new File("jasperTemplates/votosPorLocal.jasper");
...
//                map.put("address", getRandomString());
    ...
    public static void main(String[] args) {
        ...
        VotosPorLocal main = new VotosPorLocal();
        main.start();
    }
}