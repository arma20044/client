...
public class VotoBlancoPorTipoLista {
 
    private Logger logger = Logger.getLogger(VotoBlancoPorTipoLista.class);
    ...
    public void start() {
        try {                                           
        	...
        	File a = new File("jasperTemplates/votosBlancosPorTipoLista.jasper");
...
//                map.put("address", getRandomString());
    ...
    public static void main(String[] args) {
        ...
        VotoBlancoPorTipoLista main = new VotoBlancoPorTipoLista();
        main.start();
    }
}