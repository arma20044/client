...
public class VotosPorDepartamento {
 
    private Logger logger = Logger.getLogger(VotosPorDepartamento.class);
   
    private JDBCExample ds = new JDBCExample();
 
    public VotosPorDepartamento() {
    }
    ...
    public void start() {
        try {                                           
        	...
        	File a = new File("jasperTemplates/votosPorDepartamento.jasper");
...
//                map.put("address", getRandomString());
    ...
    public static void main(String[] args) {
        ...
        VotosPorDepartamento main = new VotosPorDepartamento();
        main.start();
    }
}