...
public class VotosPorZona {
 
    private Logger logger = Logger.getLogger(VotosPorZona.class);
    ...
    public void start() {
        try {                                           
        	...
        	File a = new File("jasperTemplates/votosPorZona.jasper");
...
//                map.put("address", getRandomString());
    ...
    public static void main(String[] args) {
        ...
        VotosPorZona main = new VotosPorZona();
        main.start();
    }
}