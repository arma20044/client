...
public class ActaCierre {
  ...
  /** The Constant LOG. */
  private static final Logger LOG = Logger.getLogger(ActaCierre.class);

  private Logger logger = Logger.getLogger(ActaCierre.class);
  ...
  public void start() {
    ...
    try {
      ...
      String reportName = "ActaCierre";
      // load report location

      File a = new File("jasperTemplates/actaCierre.jasper");
    ...
    /*  JasperReport sub1 =
      ...
      Integer cantidadVotosNumero = actadao.obtenerCantidadVotosByMesayEvento(acta.getIdMesa().getIdMesa(), acta.getIdMesa().getIdEvento().getIdEvento());
     ...
     // parameters.put("SUBREPORT_DIR2", sub2);
      ...
      parameters.put("P_VOTOS_NUMERO", cantidadVotosNumero);
      parameters.put("P_VOTOS_LETRAS", nTL.convertNumberToLetter(cantidadVotosNumero).toLowerCase());
  ...
  public static void main(String[] args) {
    ...
    ActaCierre main = new ActaCierre();
    main.start();
  }
}
