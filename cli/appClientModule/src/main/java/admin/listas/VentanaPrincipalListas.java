...
public class VentanaPrincipalListas extends JFrame implements ActionListener{
	...
	public VentanaPrincipalListas() {
		...
		labelTitulo.setText("MENÚ DE ADMINISTRACIÓN DE LISTAS.");
		...
		areaIntroduccion.setText("En esta ventana podrá realizar operaciones de ABM sobre la tabla de Listas del Sistema.");
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource()==botonRegistrar) {
			VentanaRegistroListas ventanaRegistro = new VentanaRegistroListas();
			ventanaRegistro.setVisible(true);
		}
		if (e.getSource()==botonBuscar) {
			VentanaBuscarListas ventanaBuscar = new VentanaBuscarListas();
