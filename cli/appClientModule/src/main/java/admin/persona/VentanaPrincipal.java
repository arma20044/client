...
public class VentanaPrincipal extends JFrame implements ActionListener{
	...
	public VentanaPrincipal() {
		...
		labelTitulo.setText("Menú de Administración de Personas.");
		...
		areaIntroduccion.setText("En esta ventana podrá realizar operaciones de ABM sobre la tabla de Personas del Sistema.");
		...
		ver.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				VentanaVer ventanaRegistro = new VentanaVer();
				ventanaRegistro.setVisible(true);
			}
		});
		ver.setText("ver");
		ver.setBounds(190, 237, 120, 25);
