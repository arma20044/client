...
public class VentanaPrincipal extends JFrame implements ActionListener{
	...
	public VentanaPrincipal() {
		...
		labelTitulo.setText("MENÚ DE ADMINISTRACIÓN DE PAISES.");
		...
		areaIntroduccion.setText("En esta ventana podrá realizar operaciones de ABM sobre la tabla de Paises del Sistema.");
