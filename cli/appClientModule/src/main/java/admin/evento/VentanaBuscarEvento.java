...
public class VentanaBuscarEvento  extends JFrame implements ActionListener {
	...
	private VentanaBuscarEvento ventanaBuscar;
	String codTemporal = "";
...
//				ver.setVisible(true);
	...
	public VentanaBuscarEvento getVentanaBuscar() {
		return ventanaBuscar;
	}


	public void setVentanaBuscar(VentanaBuscarEvento ventanaBuscar) {
	...
	private void recuperarDatos(){
		...
		boolean existe=false;
			...
			query.setQueryGenerico("SELECT id_evento,nro_evento, ev.descripcion, tev.descripcion as tipo, to_char(ev.fch_ins, 'DD/MM/YYYY HH24:MI:SS'), "
					+ "ev.usuario_ins, to_char(ev.fch_upd, 'DD/MM/YYYY HH24:MI:SS') as fchupd,ev.usuario_upd as usuupd "
