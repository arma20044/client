        	...
        	public void actionPerformed(ActionEvent e) {
        		...
        		
        		{
        			int rows = jTable1.getRowCount();
        			 ...
        			 String descripcion[] =new String[4]; // name is array and index 4 means no. of row 
        			 String codigo[]=new String[4]; //age is array and index 4 means no. of row  
        			//loop from 0 row to 4
        			for(int i=0;i<rows;i++) 
        			 {
        			 descripcion[i]=jTable1.getValueAt(i,0).toString(); // it get value from 0 row and 0 column
        			 codigo[i]=jTable1.getValueAt(i,1).toString();  // it get value from 0 row and 1 column
        			...
        			int mc=s1.executeUpdate("insert into ucsaws_genero(id_genero, descripcion,codigo, id_evento, fch_ins,usuario_ins,  fch_upd,usuario_upd) "
        	+ "values(nextval('ucsaws_genero_seq'),    '"+descripcion[i]+"','"+codigo[i]+"', " +  VentanaBuscarEvento.evento + ", now(), '" 
        	+ Login.userLogeado
			+ "' , now(), '"
			+ Login.userLogeado + "' )");
