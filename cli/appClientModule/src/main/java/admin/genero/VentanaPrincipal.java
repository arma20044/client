...
public class VentanaPrincipal extends JFrame implements ActionListener{
	...
	public VentanaPrincipal() {
		...
		labelTitulo.setText("Menú de Administración de Generos.");
		...
		areaIntroduccion.setText("En esta ventana podrá realizar operaciones de ABM sobre la tabla de Generos del Sistema.");
