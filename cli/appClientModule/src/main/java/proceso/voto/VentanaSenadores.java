...
public class VentanaSenadores extends JFrame implements ActionListener{
	...
	JLabel lblNewLabel = new JLabel("CANDIDATOS A SENADORES");
	...
	rdbLista1.addMouseListener(new MouseAdapter() {
		...
		public void mouseClicked(MouseEvent arg0) {
			senadores = rdbLista1 .getText().substring(rdbLista1.getText().length()-1, rdbLista1.getText().length());
			System.out.println("SENADORES " + senadores);
		}
	});
	...
	rdbLista2.addMouseListener(new MouseAdapter() {
		@Override
		public void mouseClicked(MouseEvent arg0) {
			senadores = rdbLista2 .getText().substring(rdbLista2.getText().length()-1, rdbLista2.getText().length());
			System.out.println("SENADORES " + senadores);
		}
	});
	...
	rdbLista3.addMouseListener(new MouseAdapter() {
		@Override
		public void mouseClicked(MouseEvent arg0) {
			senadores = rdbLista3 .getText().substring(rdbLista3.getText().length()-1, rdbLista3.getText().length());
			System.out.println("SENADORES " + senadores);
		}
	});
