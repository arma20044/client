...
public class Login extends javax.swing.JFrame implements KeyListener {
	...
	public Login() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(
				Login.class.getResource("/imgs/paraguay.png")));
		initComponents();
	...
	private void initComponents() {
		...
		botonEntrar.setIcon(new ImageIcon(Login.class
				.getResource("/imgs/key.png")));
		...
		labelImagen.setIcon(new ImageIcon(Login.class
				.getResource("/imgs/PadLock-128.png"))); // NOI18N
	...
	private void botonEntrarActionPerformed(java.awt.event.ActionEvent evt)
			throws ParseException {// GEN-FIRST:event_botonEntrarActionPerformed
		...
		if (autenticado.getIdUser() != null) { // admin
			...
			nombreApellidoUserLogeado = autenticado.getUcsawsPersona().getNombre() + " " + autenticado.getUcsawsPersona().getApellido();
			email = autenticado.getUcsawsPersona().getEmail();
			/*
			 * VentanaBuscar miVentanaPrincipal; Instanciamos el objeto
			 * miVentanaPrincipal= new VentanaBuscar(); Enviamos el objeto como
			 * parametro para que sea unico en toda la aplicaci�n
	...
	private void campoContrasenaKeyPressed(java.awt.event.KeyEvent evt)
			throws ParseException {// GEN-FIRST:event_campoContrasenaKeyPressed
		if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
			...
			if (autenticado.getIdUser() != null) { // admin
				...
				MenuPrincipal menuPrincipal = new MenuPrincipal();
				/*
				 * Enviamos el objeto como parametro para que sea unico en toda
				 * la aplicaci�n
				 */
				// miVentanaPrincipal.setVentanaBuscar(miVentanaPrincipal);
				/* Hacemos que se cargue la ventana */
